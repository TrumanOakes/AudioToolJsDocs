...
> For the complete field listing with types, defaults, and ranges, see [SpitfireLabsVst3Plugin](../../api-reference/generated/types/entities.SpitfireLabsVst3Plugin.html).
