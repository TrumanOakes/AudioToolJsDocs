...
> [!NOTE]
> The login flow described here is intended for browser-based apps. For server-side apps, you can use [PAT-based authentication](./login.html#pat-based-authentication).
